...
<html>
	...
	<body>
		...
		<script type="text/javascript">  
			...
			//BOUTONS ACTUALISATION ///////////////////////////////////////////////////////////////////////////////////////			$('.demo-content').append('<button id="bActualiser1" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" style="position: absolute; border-radius: 40px; left: 10.2%; top: 29.4%; width:1%; height: 3%; min-width: 0%; min-height: 0%; z-index:1; background-color: #2196F3; color:#FFFFFF;"><i class="material-icons"></i></button>');			$('.demo-content').append('<button id="bActualiser2" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" style="position: absolute; border-radius: 40px; left: 10.2%; top: 34.4%; width:1%; height: 3%; min-width: 0%; min-height: 0%; z-index:1; background-color: #2196F3; color:#FFFFFF;"><i class="material-icons"></i></button>');			$('.demo-content').append('<button id="bActualiser3" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" style="position: absolute; border-radius: 40px; left: 10.2%; top: 39.4%; width:1%; height: 3%; min-width: 0%; min-height: 0%; z-index:1; background-color: #2196F3; color:#FFFFFF;"><i class="material-icons"></i></button>');
				...
				$.ajax({					
					...
					success: function (data) {
						...
						$(data).find("a:contains(" + fileextension + ")").each(function () {
							...
							{
								var filename = this.href.replace("http://localhost:8080/ailipse/", "").replace(".xml", "");
							}
							else{
								var filename = this.href.replace("http://localhost:8080/ailipse/", "").replace(".xml", "");
							}
			...
			var createScene = function () {
				...
				$('#bControles').click(function () {
					...
					}).find('.btn-primary').removeClass("btn-primary").addClass("mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent").css({'background-color':'#2196F3', 'color' : '#FFFFFF'});
				})
		
				//Actualisation des couleurs
				$('#bActualiser1').click(function () {					setBgColor(layer,document.getElementById("bgColor").value);				})								$('#bActualiser2').click(function () {					setMaterialColor(constructeurMat,document.getElementById("constructeurColor").value);				})								$('#bActualiser3').click(function () {					setMaterialColor(matC,document.getElementById("clientColor").value);					ribbonClientR.dispose();					ribbonClientR = getRibbon(document.getElementById("scaleDiff").value, RclientTab, false, alpha, nb_suspente, coeff, scene);					ribbonClientR.material = matC;					ribbonClientL.dispose();					ribbonClientL = getRibbon(document.getElementById("scaleDiff").value, LclientTab, true, alpha, nb_suspente, coeff, scene);					ribbonClientL.material = matC;				})
				///////////////////////////////////////////////////////////////////////////////////////////////////////////////
