...
if(!class_exists("Operateur"))
{
					...
					<form  action="modele/formulaires/valider_voile.php" method="post" enctype="multipart/form-data">
						<div class="content-grid mdl-grid">
							...
							<div class="mdl-cell">
								...
								<br />
								<br />
								<button type="button" onclick="window.location=\'index.php?a=ajout_materiaux\'" name="submit"class="mdl-button mdl-js-button mdl-button--raised" >
									Ajouter matriaux
								</button>
								<br />
								<br />
	...
	<h2 class="mdl-card__title-text">Opérateur</h2>
		...
		<div class="mdl-cell">
			<figure><a href="index.php?a=modifier_voile"><img width="250" height="200" src="vue/images/modifier.png" /></a></figure>
